...
<body style="background-color: #9772FB;">
    <div class="container-fluid">
        <div class="row" >
            <div class="col-lg-12 col-md-9 col-sm-8 col-12 vh-50 mt-2 text-left text-white"
                                ...
                                <div class="card text-white" style="border-radius: 1rem; background-color: #764AF1;">
                                    <div class="card-body p-5 text-center">
                                        <div class="mb-md-5 mt-md-4 pb-5">
                                            <h2 class="fw-bold mb-2 text-uppercase">Login  database UKDW</h2>
